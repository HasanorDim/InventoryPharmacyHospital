...
const inventoryData = {
  stockLevels: [
    ...
    },
    {
      ...
      form: "tablets",
      targetStock: 300,
      currentStock: 15, // Changed to critical (below 15% of target)
    ...
    },
    {
      ...
      form: "tablets",
      targetStock: 250,
      currentStock: 20, // Changed to critical (below 25)
    ...
    },
    {
      ...
      form: "tablets",
      targetStock: 160,
      currentStock: 20, // Changed to critical (below 16)
      thresholdPercentage: 0.2,
    ...
    },
    {
      ...
      form: "injection",
      targetStock: 100,
      currentStock: 15, // Changed to critical (below 20)
      thresholdPercentage: 0.2,
        ...
        <div className="flex flex-col gap-5">
          ...
          >
            <List
              ...
              renderItem={(item) => (
                <List.Item>
                  <div className="flex justify-content-center place-content-center">
                    <FiBox className="text-blue-500 mr-2" />{" "}
                    <div>
